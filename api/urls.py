...
urlpatterns = [
    ...
    path('subjectlist1/<int:id>/', views.SubjectList1.as_view()),
    ...
    path('semesterlist/', views.SemesterList.as_view()),
    path('semesterlist/<int:id>/', views.SemesterList.as_view()),
    path('pdflist/<int:subject_id>/', views.PdfList.as_view()),
